...
resume_data = {
    ...
    "experience": [
        {"role": "Software Developer", "company": "TechCorp", "years": "2022 - Present", "description": "Developed AI-powered resume ranking system."},
        {"role": "Intern", "company": "Startup Inc.", "years": "2021 - 2022", "description": "Worked on backend APIs and AI models."}
    ],
...
with ui.card().classes("m-4 p-6 shadow-lg bg-gray-100"):
    ...
    def process_question():
        ...
        if question:
            chat_output.set_text(f"Identify the strengths and weaknesses in this resume")
